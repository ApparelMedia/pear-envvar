...
},{"matches-selector":23}],2:[function(require,module,exports){
...
},{"whatwg-fetch":24}],23:[function(require,module,exports){
...
delegate(document.body, '.remove-row', 'click', function (e) {
    e.preventDefault();
...
function checkConnection(target, iconEl) {
    fetch('/api/connections/' + target.value + '/check').then(function (response) {
...
[].forEach.call(checkedInputs, function (input) {
    var iconEl = document.querySelector('#connection_icon_' + input.value);
    setLoading(iconEl);
    fetch('/api/connections/' + input.value + '/check').then(function (response) {
        return response.json();
    }).then(function (json) {
        setSuccessful(iconEl);
    });
...
delegate(document.querySelector('.connections-container'), '.connection', 'click', function (e) {
    var target = e.delegateTarget;
    var iconEl = document.querySelector('#connection_icon_' + target.value);
    if (target.checked) {
        setLoading(iconEl);
...
},{"./template/envvar-row.handlebars":26,"delegate":2,"isomorphic-fetch":22}],26:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"row variable envvar-row\">\n    <div class=\"four columns\"><input type=\"text\" class=\"code-input\" name=\"variables[key][]\" value=\"\"></div>\n    <div class=\"six columns\"><input type=\"text\" class=\"code-input\" value=\"\" name=\"variables[value][]\"></div>\n    <div class=\"two columns\"><a href=\"#\" class=\"button close remove-row\"><i class=\"fa fa-times-circle\"></i></a></div>\n</div>";
},"useData":true});
